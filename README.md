...
The datasets can be found in the corresponding websit: [UTKFace](https://github.com/paplhjak/Facial-Age-Estimation-Benchmark-Databases), [Yelp Review](https://github.com/pm25/regression-datasets), and [BVCC](https://github.com/pm25/regression-datasets).
...
[Semi-supervised Regression](https://github.com/pm25/Semi-Supervised-Regression)
